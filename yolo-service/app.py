...
from yolo_utils import (
    load_yolo_model, handle_camera_disconnection, publish_message,
    generate_embeddings, create_rabbitmq_channel, initialize_resources,
    release_resources
)
...
def status():
    ...
    return jsonify({
        ...
        "last_detection": time.strftime('%Y-%m-%dT%H:%M:%SZ', time.gmtime(last_detection_time)) if last_detection_time else "No detections yet"
    })
